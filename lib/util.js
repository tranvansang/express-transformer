...
exports.isString = exports.recursiveHas = exports.recursiveDefault = exports.recursiveGet = exports.recursiveSet = void 0;
...
var recursiveGet = function recursiveGet(obj, path, value) {
  return path.split('.').reduce(function (acc, cur, index, pathArray) {
    return acc instanceof Object && acc.hasOwnProperty(cur) ? acc[cur] : index === pathArray.length - 1 ? value : undefined;
  }, obj);
};
...
var recursiveHas = function recursiveHas(obj, path) {
  ...
  try {
    for (var _iterator = path.split('.')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (obj instanceof Object && obj.hasOwnProperty(_key)) {
        obj = obj[_key];
      } else return false;
    }
  } catch (err) {
