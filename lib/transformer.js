...
function transformer(path) {
  ...
  middleware.toInt = function () {
    ...
    return middleware.each(function (value, _ref11) {
      ...
      if (option.hasOwnProperty('min') && value < option.min) throw new Error("".concat(path, " must be at least ").concat(option.min));
      if (option.hasOwnProperty('max') && value > option.max) throw new Error("".concat(path, " must be at most ").concat(option.max));
      return value;
    });
  };
  ...
  middleware.toFloat = function () {
    ...
    return middleware.each(function (value, _ref12) {
      ...
      if (option.hasOwnProperty('max') && value > option.max) {
