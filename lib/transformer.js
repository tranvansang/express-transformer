...
function (_Error) {
  ...
  function TransformationError(message) {
    ...
    {
      try {
        _this = _possibleConstructorReturn(this, _getPrototypeOf(TransformationError).call(this, message));
      } catch (err) {}
...
function transformer(path) {
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              regeneratorRuntime.mark(function _callee3() {
                var hasError, message, forcedMessage, appendError, fullPath, doSubtransform, doTransform, _i2, _ref8, _type, _callback, _force, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, p, values;
                    ...
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        fullPath = function fullPath(p) {
                          return [location, p].filter(Boolean).join('.');
                        };
                        /**
                         *
                              ...
                              while (1) {
                                switch (_context.prev = _context.next) {
                                  ...
                                  case 6:
                                    ...
                                    _context.next = 9;
                                    return doSubtransform(_toConsumableArray(prefix).concat([String(i)]), arrays, inlinePath, callback, force);
                                ...
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 11:
                                    ...
                                    inlinePath.forEach(function (p, i) {
                                      return (0, _util.recursiveSet)(req, fullPath(p), sanitized && sanitized[i]);
                                    });
                      ...
                      case 8:
                        ...
                        _ref8 = stack[_i2];
                        _type = _ref8.type, _callback = _ref8.callback, _force = _ref8.force;
                      ...
                      case 22:
                        ...
                        _context3.next = 28;
                        return doTransform(p, _callback, _force);
                      ...
                      case 50:
                        _context3.next = 52;
                        return doTransform(path, _callback, _force);
                      ...
                      case 54:
                        ...
                        if (!(0, _util.isString)(_callback)) {
                          _context3.next = 61;
                          break;
                        }

                        _context3.t3 = _callback;
                        _context3.next = 64;
                        break;
  ...
  var _loop = function _loop() {
    ...
    if (vKey.startsWith('is')) middleware[vKey] = function () {
      ...
      return middleware.each(function (value, _ref20) {
      ...
      return middleware.each(function (value, _ref21) {
  ...
  middleware.toInt = function () {
    ...
    var min = _ref11.min,
        max = _ref11.max,
        transformOption = _objectWithoutProperties(_ref11, ["min", "max"]);

    return middleware.each(function (value, _ref12) {
      var path = _ref12.path;
      value = parseInt(value);
      if (isNaN(value) || !isFinite(value)) throw new Error("".concat(path, " must be an integer"));
      if (min !== undefined && value < min) throw new Error("".concat(path, " must be at least ").concat(min));
      if (max !== undefined && value > max) throw new Error("".concat(path, " must be at most ").concat(max));
      return value;
    }, transformOption);
  };
  ...
  middleware.toFloat = function () {
    ...
    var min = _ref13.min,
        max = _ref13.max,
        transformOption = _objectWithoutProperties(_ref13, ["min", "max"]);

    return middleware.each(function (value, _ref14) {
      var path = _ref14.path;
      value = parseFloat(value);
      if (isNaN(value) || !isFinite(value)) throw new Error("".concat(path, " must be a number"));
      if (min !== undefined && value < min) throw new Error("".concat(path, " must be at least ").concat(min));

      if (max !== undefined && value > max) {
        throw new Error("".concat(path, " must be at most ").concat(max));
      }
  ...
  middleware.isIn = function (values, transformOptions) {
  ...
  middleware.isLength = function (option, transformOption) {
  ...
  middleware.matches = function (regex, transformOption) {
  ...
  middleware.toDate = function () {
    var _ref18 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var resetTime = _ref18.resetTime,
        transformOption = _objectWithoutProperties(_ref18, ["resetTime"]);

    return middleware.each(function (value, _ref19) {
      var path = _ref19.path;
      var time = Date.parse(value);
      if (isNaN(time) || !isFinite(time)) throw new Error("".concat(path, " must be in date format"));
