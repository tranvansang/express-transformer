...
var _default = function _default(path) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee2(req, res, next) {
      var hasError, message, forcedMessage, appendError, fullpath, getValue, setValue, doTransform, _i, _ref5, type, callback, force, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, p;
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 15:
              _context2.t0 = type;
              _context2.next = _context2.t0 === 'every' ? 18 : _context2.t0 === 'transformer' ? 52 : _context2.t0 === 'message' ? 56 : 83;
              break;
      ...
      }, _callee2, this, [[0, 89], [22, 38, 42, 50], [43,, 45, 49], [56, 78]]);
    }));
  ...
  middleware.isLength = function (option) {
    return middleware.each(function (value, _ref11) {
      ...
      if ((0, _util.isString)(value)) {
        if ('min' in option && value.length < option.min) throw new Error("".concat(path, " must be at least ").concat(option.min, " characters long"));
        if ('max' in option && value.length > option.max) throw new Error("".concat(path, " must be at most ").concat(option.max, " characters long"));
        return value;
      }
